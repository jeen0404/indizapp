  ...
  Widget build(BuildContext context) {
    ...
    Widget logo =             Row(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Image(image: AssetImage("assets/icon.png"),width: 75.0,height: 75.0,),
        )
      ],
    );
    Widget AppName =             Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        Text("I N D I Z",style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold,fontSize: 22.0),),
      ],
    );
    ...
    Future<bool> checkifperivioulyloedinwithgmail (FirebaseUser user) async{
     await FirebaseDatabase.instance.reference().child("users").orderByChild("email").equalTo(user.email).once()
          .then((result){
        if(result.value == null){
          sharpref.setInt("login_status", 1);
          Navigator.pop(context);
          Navigator.pushAndRemoveUntil(context,MaterialPageRoute(builder: (builder)=>uploadinfo()),(Route<dynamic> route)=>false);
        }else{
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: <Widget>[
          Center(child:Container(height: 300.0,child: FlareActor("flar/bob.flr", alignment:Alignment.center, animation:"Wave",fit: BoxFit.fill,)),),
          ...
          Container(
            ...
            child: Column(
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  Text("Be artistic and let's engage",style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold,fontSize:15.0),),
                ],
              ),
