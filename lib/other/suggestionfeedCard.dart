...
class _SuggestionfeedCardState extends State<SuggestionfeedCard> {
  var userid;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: loding==true?Container(height:200.0,width: 140,child: Center(child:CircularProgressIndicator(),),):
      Container(
        height:200.0,
        width: 140.0,
        decoration: BoxDecoration(border: Border.all(color: Colors.blueAccent,width: 1.0),borderRadius: BorderRadius.circular(5.0)),
        child:   Column(
          children: <Widget>[
            Row(
            ...
            Padding(
              ...
              child: GestureDetector(
                ...
                child: Container(height:30.0,width: 100.0,decoration:BoxDecoration(border: Border.all(color: Colors.blueAccent,width: 1.0),borderRadius: BorderRadius.circular(2.0)),
                  child: Center(child: Text(f_f_text,style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold),),),
                ),
              ),
